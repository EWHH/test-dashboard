...
function setupFilters() {
  ...
  filterBtn.addEventListener('click', () => {
    const welcomeFilter = document.getElementById('filterWelcomeCall').value.toLowerCase();
    const parentFilter = document.getElementById('filterTargetParent').value.toLowerCase();
    const interestFilter = document.getElementById('filterProductInterest').value.toLowerCase();
...
// Auto-fetch call history on page load
window.onload = fetchCallHistory;
